...
<main class="page__main page__main--publication">
    <div class="container">
        ...
        <section class="post-details">
            ...
            <div class="post-details__wrapper post-<?= $postIcon ?>">
                <div class="post-details__main-block post post--details">
                    <?php if ($postIcon === 'text'): ?>
                        <?= include_template('post/text.php', [
                            'text' => $postContent,
                        ]); ?>
                    <?php elseif ($postIcon === 'quote'): ?>
                        <?= include_template('post/quote.php', [
                            'text' => $postContent,
                            'author' => $postAuthor
                        ]); ?>
                    <?php elseif ($postIcon === 'video'): ?>
                        <?= include_template('post/video.php', [
                            'youtubeUrl' => $postContent,
                        ]); ?>
                    <?php elseif ($postIcon === 'photo'): ?>
                        <?= include_template('post/photo.php', [
                            'imgUrl' => $postContent,
                        ]); ?>
                    <?php elseif ($postIcon === 'link'): ?>
                    ...
                    <div class="post__indicators">
                        ...
                        <span class="post__view">
                            <?= $post['views'] ?>
                            <?= get_noun_plural_form($post['views'], 'просмотр', 'просмотра', 'просмотров'); ?>
                        </span>
                    </div>
                    <ul class="post__tags">
                ...
                <div class="post-details__user user">
                    <div class="post-details__user-info user__info">
                        <div class="post-details__avatar user__avatar">
                            <a class="post-details__avatar-link user__avatar-link" href="#">
                                <img class="post-details__picture user__picture" src="img/<?= $userAvatar; ?>"
                                     alt="Аватар пользователя">
                            </a>
                        </div>
                    ...
                    <div class="post-details__rating user__rating">
                        <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                            <span
                                class="post-details__rating-amount user__rating-amount"><?= $userSubscribers; ?></span>
